...
{
    return std::ranges::none_of(extractEmails(key), [email](const QString &emailItem) {
...
public:
    ...
    QString label() const
    {
        ...
        if (verify && decrypt) {
            if (error.isCanceled()) {
                return i18nc("@info", "Decryption and verification canceled.");
            ...
            if (error.isCanceled()) {
                return i18nc("@info", "Verification canceled.");
            } else if (error) {
            ...
            if (error.isCanceled()) {
                return i18nc("@info", "Decryption canceled.");
            } else if (error.code() == GPG_ERR_NO_SECKEY) {
